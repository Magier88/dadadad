...
function GM:ScoreboardShow()
	...
	local function player_add(ply)
		...
		backgroud.Think = function()
			...
			if 	ply:UserGroup(developer) then
				rank:SetTextColor(Color(0, 0, 0))
				 rank:SetText('Developer')
			elseif ply:UserGroup(admin) then
					rank:SetTextColor(Color(0, 0, 0))
					 rank:SetText('Admin')
				elseif ply:UserGroup(moderator) then
					rank:SetTextColor(Color(0, 0, 0))
					 rank:SetText('Moderator')
				else ply:UserGroup(donator) then
					rank:SetTextColor(Color(0, 0, 0))
					 rank:SetText('Donator')
				else
